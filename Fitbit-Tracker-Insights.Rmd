...
1. Explore data - find total number of rows, distinct values
2. Prep data - clean data, combine and condense datasets
3. Note trends, calculate summary statistics, mins and maxes
Final -  Export to R for modeling and visualizations
