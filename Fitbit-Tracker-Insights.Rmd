...
- Prep dataset - check for distinct users, merge tables, remove missing values and duplicates, identify mistyped data, add day-of-week column

- Perform exploratory data analysis - activity levels by user (steps, activity intensity), summary statistics (steps, distance, intensity, calories, sleep - by day)
...
```{sql, connection = con, output.var = "dowtest"}
# query from joined table
