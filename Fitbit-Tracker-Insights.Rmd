...
SQL Data Prep Objectives - check for distinct users, merge tables, remove missing values and duplicates, identify mistyped data, add day-of-week column.
...
Initial exploratory analysis will involve understanding user-specific activity data, and general summary statistics of the variables in the dataset.
